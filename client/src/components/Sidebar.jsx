...
import { LayoutGrid, BarChart3, Users, GraduationCap, LogOut } from "lucide-react";
  ...
  return (
    <aside className="flex h-screen w-[280px] flex-col border-r border-app-border bg-app-panel">
      <div className="px-6 py-6">
        <span className="font-serif text-2xl font-bold text-red-600">LabsKraft</span>
      </div>
      ...
      <div className="flex items-center justify-between border-t border-app-border px-4 py-4">
        <div className="min-w-0">
          ...
          <p className="truncate text-xs text-app-muted">{user?.role}</p>
        </div>
        <button
          type="button"
          onClick={onLogout}
